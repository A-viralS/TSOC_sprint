...
<!-- 8e684b3af554d8f1f7efd55a494af0afb42757de1467f287ccc50e24702edb83 -->
<div
  class="m-20 pt-10 w-full max-w-xl p-12 mx-auto rounded-lg shadow-xl dark:bg-white/10 bg-white/30 ring-1 ring-gray-900/5 backdrop-blur-lg"
>
  ...
  {#if form?.success}
    <p class="pt-2">File uploaded successfully. Transaction ID: {form?.txid}</p>
  {/if}
  {#if form?.error}
    <p class="pt-2">Error: {form?.error}</p>
  {/if}
</div>